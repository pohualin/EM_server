...
public class TeamPersistenceIntegrationTest extends BaseIntegrationTest {
    ...
    public void getTeamsWithNoTeamTags() {
        ...
        TeamSearchFilter filter = new TeamSearchFilter(client1.getId(),TeamSearchFilter.StatusFilter.ACTIVE_ONLY,TeamSearchFilter.TeamTagType.UNTAGGED_ONLY);
    ...
    public void getInactiveTeamsWithNoTeamTags() {
        ...
        TeamSearchFilter filter = new TeamSearchFilter(client1.getId(),TeamSearchFilter.StatusFilter.INACTIVE_ONLY,TeamSearchFilter.TeamTagType.UNTAGGED_ONLY);
    ...
    public void getAllTeamsWithNoTeamTags() {
        ...
        TeamSearchFilter filter = new TeamSearchFilter(client1.getId(),TeamSearchFilter.StatusFilter.ALL,TeamSearchFilter.TeamTagType.UNTAGGED_ONLY);
