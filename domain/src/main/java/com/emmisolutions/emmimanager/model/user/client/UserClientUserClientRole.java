...
/**
 * Link between a client users and client roles. Aka the client roles for a client user.
 */
@Audited
@Entity
@Table(name = "user_client_user_client_role",
    uniqueConstraints =
    @UniqueConstraint(columnNames = {"users_id", "user_client_role_id"},
        name = "uk_user_client_user_client_role")
)
public class UserClientUserClientRole extends AbstractAuditingEntity {
    ...
    @JoinColumn(name = "user_client_role_id", nullable = false, columnDefinition = "bigint",
        foreignKey = @ForeignKey(name = "fk_user_client_user_client_role_role")
    )
    ...
    @JoinColumn(name = "users_id", nullable = false, columnDefinition = "bigint",
        foreignKey = @ForeignKey(name = "fk_user_client_user_client_role_users")
    )
    ...
    public String toString() {
        return "UserClientUserClientRole{" +
            "id=" + id +
