...
public class ClientResourceAssembler implements ResourceAssembler<Client, ClientResource> {
     ...
     * @see com.emmisolutions.emmimanager.web.rest.resource.UserClientsResource#getUsers(Long, org.springframework.data.domain.Pageable, org.springframework.data.domain.Sort, org.springframework.data.web.PagedResourcesAssembler, String, String, Long, Long)
     */
