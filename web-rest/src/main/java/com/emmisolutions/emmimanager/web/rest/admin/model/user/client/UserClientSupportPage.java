 ...
 */
@XmlRootElement(name = "user-client-support-page")
public class UserClientSupportPage extends PagedResource<UserClientResource> {

    @XmlElement(name = "filter")
    private UserClientSupportSearchFilter filter;

    public UserClientSupportPage() {
    }
     ...
     */
    public UserClientSupportPage(
            PagedResources<UserClientResource> userResources,
            Page<UserClient> userPage, UserClientSupportSearchFilter filter) {
    ...
    private void addFilterToLinks(UserClientSupportSearchFilter filter) {
        this.filter = filter;
